...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    bump: {
      options: {
        ...
        tagMessage: '%VERSION%',
        push: true,
        pushTo: 'git@github.com:dalekjs/dalek-internal-reporter.git'
      }
    },
  ...
  grunt.registerTask('archive', function () {
    ...
    grunt.util.spawn({cmd: 'git', args: ['describe', '--abbrev=0', '--tags']}, function (error, result) {
      ...
      if (grunt.file.isFile('_raw/docs/' + lastTag + '/reporter.html')) {
      ...
      grunt.file.copy('report/docs/reporter.html', '_raw/docs/' + lastTag + '/reporter.html');

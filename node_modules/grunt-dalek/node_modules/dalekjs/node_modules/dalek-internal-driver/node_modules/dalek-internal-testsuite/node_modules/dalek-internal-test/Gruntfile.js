...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    bump: {
      options: {
        ...
        tagMessage: '%VERSION%',
        push: true,
        pushTo: 'git@github.com:dalekjs/dalek-internal-test.git'
      }
    },
  ...
  grunt.registerTask('release-canary', function () {
    ...
    indexContents = indexContents.replace('dalek-internal-actions', 'dalek-internal-actions-canary');
    indexContents = indexContents.replace('dalek-internal-assertions', 'dalek-internal-assertions-canary');

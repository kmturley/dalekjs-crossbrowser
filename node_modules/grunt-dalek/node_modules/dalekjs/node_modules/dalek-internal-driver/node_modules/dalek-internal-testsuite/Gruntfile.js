...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    bump: {
      options: {
        ...
        tagMessage: '%VERSION%',
        push: true,
        pushTo: 'git@github.com:dalekjs/dalek-internal-testsuite.git'
      }
    },
  ...
  grunt.registerTask('archive', function () {
    ...
    grunt.util.spawn({cmd: 'git', args: ['describe', '--abbrev=0', '--tags']}, function (error, result) {
      ...
      if (grunt.file.isFile('_raw/docs/' + lastTag + '/testsuite.html')) {
      ...
      grunt.file.copy('report/docs/testsuite.html', '_raw/docs/' + lastTag + '/testsuite.html');
  ...
  grunt.registerTask('release-canary', function () {
    ...
    indexContents = indexContents.replace('dalek-internal-test', 'dalek-internal-test-canary');
